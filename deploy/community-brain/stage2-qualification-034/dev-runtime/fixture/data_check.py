...
if sys.argv[1]=='excluded':
 identity={'meeting_id':'request034-excluded','local_date':'2026-09-08','started_at':'2026-09-08T22:00:00Z','timezone':'America/Toronto','provider':'manual'}
 source=store.add_source('community-brain','request034-excluded','transcript','Excluded synthetic source')
 job,_=store.accept('community-brain','fixture','request034-excluded',{'identity':identity,'mode':'transcript_backfill','sources':{'transcript':str(source)}})
