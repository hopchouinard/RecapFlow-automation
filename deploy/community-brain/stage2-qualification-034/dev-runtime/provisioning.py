"""Fresh Request034 data only. Private authority values never enter receipts."""
...
def private_files(values):
 ...
 (state/'automation/paused').write_text('disposable Request034 bootstrap hold\n')
 ...
 raw=b'Request034 synthetic archive. No production data.\n';digest=hashlib.sha256(raw).hexdigest()
 ...
 ca=base64.b64decode(values['CB_DEV_NATS_CA_B64']).decode()
 atomic(PRIVATE/'queue-ca.pem',ca,0o644);atomic(PRIVATE/'ca-bundle.pem',ca,0o644)
