...
NAMES=['workload.py','initialize_authority.py','stage_packet.py','build_packet.py','authority.py','successor.py','host.py','consumers.py','kuma.js','test_boundaries.py',
 ...
 'provisioning.py','automation.py','validation_host.py']
